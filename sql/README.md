...
`core_pipeline/` is the complete ordered OCS/GPAD raw-source reconstruction for the verified reference application. It preserves the exact known source schemas, expected counts and twelve-month annual feature rules.
