...
def architecture() -> None:
    boxes = [
        ...
        Box(250, 695, 1100, 86, ("Coverage-preserving practice-month spine",), PALE_GOLD, GOLD, 18, INK, 27, True),
        Box(170, 835, 560, 96, ("Question-specific joins", "Source-led and matched populations"), WHITE, BLUE, 18, INK, 26, True),
        Box(870, 835, 560, 96, ("Annual reference matrices", "Exactly 12 complete eligible months"), WHITE, BLUE, 18, INK, 26, True),
        Box(390, 980, 820, 72, ("Validation, analysis and reuse",), NAVY, NAVY, 18, WHITE, 28, True),
    ...
    arrows = [
        ...
        Arrow(800, 647, 800, 695),
        Arrow(800, 781, 450, 835),
        Arrow(800, 781, 1150, 835),
        Arrow(450, 931, 650, 980),
        Arrow(1150, 931, 950, 980),
    ]
    save_visual(
        "pcadi-architecture",
        1600,
...
def cohort_flow() -> None:
    boxes = [
        ...
        Box(255, 800, 890, 82, ("Nested evidence-availability cohorts", "Smaller cohorts are not sequential quality grades"), NAVY, NAVY, 18, WHITE, 25, True),
    ]
    arrows = [
