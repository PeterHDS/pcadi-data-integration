...
The cohort is a complete-case, twelve-month practice panel for the selected source vintage. It contains practices meeting every month and feature rule. Supplier coverage, missing months and undefined ratios can produce systematic differences between retained and absent practices.
