...
This tutorial uses deterministic synthetic data so the pipeline can be studied without NHS downloads.
...
Choose one practice and month. Compare it across OCS, GPAD, CBT, the union spine and a matched output. Notice that:
...
The [analytical design index](../analytical-designs/README.md) explains why each population differs.
