...
A research or reference-output reviewer can:
...
5. Inspect the national annual matrix through the [reference-output inspection guide](audiences/reference-inspection-guide.md).
